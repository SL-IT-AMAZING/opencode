...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/SL-IT-AMAZING/opencode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for SL-IT-AMAZING/opencode...\n")
