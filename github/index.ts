...
function useShareUrl() {
  return isMock() ? "https://dev.anyon.cc" : "https://anyon.cc"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.anyon.cc/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.anyon.cc/exchange_github_app_token", {
      method: "POST",
      headers: {
