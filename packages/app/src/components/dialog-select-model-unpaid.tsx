...
import { List, type ListRef } from "@anyon/ui/list"
import { ProviderIcon } from "@anyon/ui/provider-icon"
import { Tag } from "@anyon/ui/tag"
  ...
  return (
    <Dialog title="Select model">
      <div class="flex flex-col gap-3 px-2.5">
        <div class="text-14-medium text-text-base px-2.5">Free models provided by ANYON</div>
        <List
          ref={(ref) => (listRef = ref)}
