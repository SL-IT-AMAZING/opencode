...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ANYON_CALLER", () => {
    process.env["ANYON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ANYON_CALLER", () => {
    process.env["ANYON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ANYON_CALLER", () => {
    process.env["ANYON_CALLER"] = "unknown"
