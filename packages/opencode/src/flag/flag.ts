export namespace Flag {
  ...
  export const ANYON_EXPERIMENTAL_ICON_DISCOVERY = ANYON_EXPERIMENTAL || truthy("ANYON_EXPERIMENTAL_ICON_DISCOVERY")
  export const ANYON_EXPERIMENTAL_DISABLE_COPY_ON_SELECT = truthy("ANYON_EXPERIMENTAL_DISABLE_COPY_ON_SELECT")
  export const ANYON_ENABLE_EXA = truthy("ANYON_ENABLE_EXA") || ANYON_EXPERIMENTAL || truthy("ANYON_EXPERIMENTAL_EXA")
