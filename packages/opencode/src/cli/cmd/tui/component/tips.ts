export const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at anyon.cc.",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/SL-IT-AMAZING/anyon{/highlight} for containerized use.",
