...
- **Using Mise**
  ...
  ```bash
  mise use -g github:SL-IT-AMAZING/opencode
  ```

- **Using Docker**

  ```bash
  docker run -it --rm ghcr.io/SL-IT-AMAZING/opencode
  ```

Support for installing OpenCode on Windows using Bun is currently in progress.

You can also grab the binary from the [Releases](https://github.com/SL-IT-AMAZING/opencode/releases).
...
1. Run the `/connect` command in the TUI, select opencode, and head to [anyon.cc/auth](https://anyon.cc/auth).
...
Here's an [example conversation](https://anyon.cc/s/4XP1fce5) with OpenCode.
