...
import { addMessageHandler, requestInit, applyTextEdits, writeAsset } from "../messaging"
...
export function App() {
  ...
  const handleImagePaste = useCallback((dataUri: string, callback: (relPath: string) => void) => {
