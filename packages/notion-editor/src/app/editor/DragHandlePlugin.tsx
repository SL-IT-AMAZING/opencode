...
function getBlockElement(target: HTMLElement, editorRoot: HTMLElement): HTMLElement | null {
...
function getBlockElementAtY(y: number, editorRoot: HTMLElement): HTMLElement | null {
    ...
    const handleDragOver = (event: DragEvent) => {
      ...
      if (blockElement) {
        ...
        if (nodeKey && nodeKey !== draggedNodeKey.current) {
          ...
          const editorRect = editorElement.getBoundingClientRect()
          const indicatorTop =
            dropPosition.current === "before" ? rect.top - editorRect.top : rect.bottom - editorRect.top
