...
export function ImageComponent({ src, alt, title, width, height, nodeKey }: ImageComponentProps): JSX.Element {
  ...
  const displayHeight =
    displayWidth && naturalWidth && naturalHeight ? Math.round(displayWidth * (naturalHeight / naturalWidth)) : height
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <>
          <div className="image-resize-handle nw" onMouseDown={(e) => handleResizeStart(e, "nw")} />
          <div className="image-resize-handle ne" onMouseDown={(e) => handleResizeStart(e, "ne")} />
          <div className="image-resize-handle sw" onMouseDown={(e) => handleResizeStart(e, "sw")} />
          <div className="image-resize-handle se" onMouseDown={(e) => handleResizeStart(e, "se")} />
        </>
      )}
