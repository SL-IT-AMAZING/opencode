...
export class ImageNode extends DecoratorNode<JSX.Element> {
  ...
  static importJSON(serializedNode: SerializedImageNode): ImageNode {
    const node = new ImageNode(serializedNode.src, serializedNode.alt, serializedNode.title)
...
export function $createImageNode(src: string, alt: string, title?: string, displaySrc?: string): ImageNode {
  const node = new ImageNode(src, alt, title)
  if (displaySrc) {
