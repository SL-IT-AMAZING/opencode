...
function positionsEqual(a: { top: number; left: number } | null, b: { top: number; left: number } | null): boolean {
...
export function SlashMenuPlugin() {
    ...
    const updateListener = editor.registerUpdateListener(({ editorState }) => {
      editorState.read(() => {
        ...
        if (spaceBelow >= menuHeight) {
          ...
          top = spaceBelow > spaceAbove ? rect.bottom + padding : rect.top - menuHeight - padding
        }
  ...
  return (
    <SlashMenu isOpen={menuState.isOpen} position={menuState.position} query={menuState.query} onClose={closeMenu} />
  )
}
